...
description: "30 lines of JS, 4 lines of CSS, zero scroll events — a scroll-aware table of contents with IntersectionObserver, rootMargin, and instant click feedback."
date: 2026-07-09
draft: false
tags: [javascript, css, ux, howto]
pageHasCode: true
image: /assets/img/og/scroll-aware-toc-intersection-observer.png
image_alt: "Terminal-style split view showing an article with a reading zone marker highlighting The Setup section, and a TOC sidebar with the matching item marked is-active in amber."
---

![Terminal-style split view showing an article with a reading zone marker highlighting The Setup section, and a TOC sidebar with the matching item marked is-active in amber.](../assets/img/scroll-aware-toc-intersection-observer.svg)

*The reading zone tells the observer where you are. The TOC tells you.*
...
The `#` links in the TOC point to heading IDs generated by markdown-it-anchor. Those same auto-generated anchors can cause phantom spacing on narrow viewports — [a CSS fix I covered separately](/posts/heading-anchor-fix/) — but for the observer's purpose, the `href="#section-id"` pattern works exactly as needed.
