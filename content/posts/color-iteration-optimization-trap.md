...
Not `#000000` vs `#ffffff`. Not navy vs charcoal. Two grays that differed by exactly 8 points of lightness — `#c8ccd6` and `#ced2dc`. Luminance difference of 0.04. A gap that, by any rational measure, no reader would ever consciously detect.
...
The final dark mode body text on this blog is `#c8ccd6`. It is not the perfect gray. There is no perfect gray.
